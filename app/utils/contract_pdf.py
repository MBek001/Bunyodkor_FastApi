...
class ContractPDFGenerator:
    ...
    def get_flowables(self):
        ...
        section2_1 = [
            ...
            "<b>2.1.8.</b> Тарбияланувчини мажбурий суғурта қилиш.",
        ]
        section2_2 = [
        ...
        section3_2 = [
            ...
            "<b>3.2.6.</b> \"ФК Бунёдкор\" МЧЖ Тошкент шаҳри филиали (болалар ва ўсмирлар футбол академияси)да тарбияланаётган ёш футбмаолчилар ота-оналарининг аҳлоқ қоидаси\"ва академиянинг бошқа локал ҳужжатлари нормаларига тўлиқ ва сўзсиз амал қилиш."
        ]
        section3_3 = [
            ...
            "<b>3.3.5.</b> Мазкур шартнома бўйича кўрсатиладиган хизматларнинг амалга оширилиши бўйича маълумотлар берилишини талаб қилиш (+998991234567 телефон рақамидан Академиянинг маркетинг-тижорат бўлими юборган барча хабарлар расмий бўлиб ҳисобланади);",
